...
import SlideImageAndPriceDetailForLens from "./SlideImageAndPriceDetailForLens";
...
export default function SlideInPanelForLens({ onClose, singleLens }: { onClose: () => void, singleLens: ILense }) {
  ...
  return (
    ...
    >
      ...
      <br />
      <SlideImageAndPriceDetailForLens singleLens={singleLens} />
    </motion.div>
  );
}
