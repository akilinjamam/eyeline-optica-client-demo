...
const EnterPowerSection = ({ cartInfo }: { cartInfo: any }) => {
  ...
  // Create arrays where 0 is in the middle
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}cart/create-cart`,
        {
          method: "POST",
  ...
  <form onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-center">
            ...
            <div>
              ...
              <select
                ...
                value={eyePower.rightEye?.sphere || "0"}
                onChange={(e) =>
                  setEyePower((prev) => ({
                    ...prev,
                    rightEye: {
            ...
            <div>
              ...
              <select
                ...
                value={eyePower.rightEye?.cylinder || "0"}
                onChange={(e) =>
                  setEyePower((prev) => ({
                    ...prev,
                    rightEye: {
            ...
            <div>
              <p className="font-medium mb-1">AXIS</p>
              <select
                value={eyePower.rightEye?.axis || "0"}
                onChange={(e) =>
                  setEyePower((prev) => ({
                    ...prev,
                    rightEye: {
    ...
    {/* Prescription Info */}
    <div className="mt-6">
      <p className="font-semibold text-xl mb-3">Whose Prescription is this?</p>
