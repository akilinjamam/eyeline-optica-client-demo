...
export default function SlideInPanelForContactLens({ onClose, singleLens }: { onClose: () => void, singleLens: ILense }) {
  ...
  return (
    ...
    >
      ...
      <br />
      <SlideImageAndPriceDetailForContactLens singleLens={singleLens} />
    </motion.div>
  );
}
