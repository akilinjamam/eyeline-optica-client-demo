...
const LensCardAuto:React.FC<TLens> = ({images, name, brand, salesPrice,  color, _id, badge, rating}) => {

    return (
    <div className="relative bg-white shadow-md p-4 rounded-md w-full h-auto">
     {/* 🔵 Badge (Top Middle) */}
    {badge && (
      ...
      <div className=" my-7 w-full flex items-center justify-center">
