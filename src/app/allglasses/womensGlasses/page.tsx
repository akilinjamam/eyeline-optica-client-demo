...
export interface PageProps {
  ...
  const WomensforGlasses = async ({ searchParams }: PageProps) => {
  ...
  const mergedParams = {biologyCategory: "women",page:"1",limit:"20",...plainParams}
...
export default WomensforGlasses;
