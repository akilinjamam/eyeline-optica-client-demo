...
async function getProduct(value:string) {
  ...
  if(value === 'biologyCategoryMan'){
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}products?weeklyDeals=false&biologyCategory=men&type=sunglasses&limit=12&page=1`, {
  ...
  if(value === 'biologyCategoryWomen'){
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}products?weeklyDeals=false&biologyCategory=women&type=sunglasses&limit=12&page=1`, {
